...
import xysoft.im.adapter.HeaderViewHolder;
import xysoft.im.adapter.ViewHolder;
...
public class RCListView extends JScrollPane
{
	 ...
	 * 滚轴列表
	 */
	private static final long serialVersionUID = 2874941216210495225L;
    ...
    private void setListeners()
    {
        adjustmentListener = new AdjustmentListener()
        {
            public void adjustmentValueChanged(AdjustmentEvent evt)
            {
                ...
                //DebugUtil.debug("Adjustment value: "+lastScrollValue);
    ...
    public void fillComponents()
    {
        ...
        for (int i = 0; i < adapter.getCount(); i++)
        {
            ...
            if (headerViewHolder != null)
            {
                ...
                //DebugUtil.debug(headerViewHolder.toString()+"-headerViewHolder added ， ");
            ...
            //DebugUtil.debug(holder.toString()+"-ViewHolder added ，用时 " + (System.currentTimeMillis() - startTime));
        }
    }
