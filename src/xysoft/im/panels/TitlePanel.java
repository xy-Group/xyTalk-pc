...
public class TitlePanel extends ParentAvailablePanel
{
	 ...
	 * 定制化标题栏
	 */
	private static final long serialVersionUID = -1059875468712449494L;
    ...
    private JLabel backforeLabel;

    private ImageIcon backforeIcon;
    ...
    private void initComponents()
    {
        ...
        titleLabel.setText("XyTalk 企业沟通协作平台");
        ...
        backforeLabel = new JLabel();
        backforeLabel.setIcon(new ImageIcon(getClass().getResource("/image/if_Messages_16.png")));
        backforeLabel.setHorizontalAlignment(JLabel.CENTER);
        backforeLabel.setOpaque(true);
        backforeLabel.addMouseListener(listener);
        backforeLabel.setPreferredSize(controlLabelSize);
        backforeLabel.setCursor(handCursor);
    ...
    private void initView()
    {
        ...
        controlPanel.add(backforeLabel);
    ...
    private class ControlLabelMouseListener extends AbstractMouseListener
    {
        ...
        public void mouseClicked(MouseEvent e)
        {
            ...
            else if (e.getComponent() == backforeLabel)
            {
            	DebugUtil.debug("定制按钮1");
            }
        }
