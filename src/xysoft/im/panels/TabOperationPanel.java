...
public class TabOperationPanel extends ParentAvailablePanel
{
	 ...
	 * Tab换页区
	 */
	private static final long serialVersionUID = -4783558371364741052L;
	private JLabel chatLabel;
    private JLabel contactsLabel;
    private JLabel moreLable;
    ...
    private void initComponents()
    {
        ...
        moreLable = new JLabel();
        moreLable.setIcon(meIconNormal);
        moreLable.setHorizontalAlignment(JLabel.CENTER);
        moreLable.setCursor(handCursor);
        moreLable.addMouseListener(clickListener);
    ...
    private void initView()
    {
        ...
        add(moreLable, new GBC(2, 0).setFill(GBC.HORIZONTAL).setWeight(1,1).setInsets(0,10,0,10));
    }
    ...
    class TabItemClickListener implements MouseListener
    {
        ...
        public void mouseClicked(MouseEvent e)
        {
            ...
            else if (e.getComponent() == moreLable)
            {
                chatLabel.setIcon(chatIconNormal);
                contactsLabel.setIcon(contactIconNormal);
                moreLable.setIcon(meIconActive);
