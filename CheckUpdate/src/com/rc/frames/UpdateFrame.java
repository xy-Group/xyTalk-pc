...
public class UpdateFrame extends JFrame
{
    ...
    private void saveFile(byte[] ret)
    {
        ...
        File oldFile = new File("xytalk.jar");
        if (oldFile.exists())
        {
            oldFile.renameTo(new File("xytalk_old.jar"));
        }

        File file = new File("xytalk.jar");
        try
        {
        ...
        {
            File oFile = new File("xytalk_old.jar");
            oFile.renameTo(new File("xytalk.jar"));
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                while (true)
                {
                    ...
                    messageLabel.setText("XyTalk 正在更新中" + dot);
    ...
    private void initComponents()
    {
        ...
        messageLabel = new JLabel("XyTalk 正在更新中...");
